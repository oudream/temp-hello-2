	...
	{
		{
			...
			printer.PushAttribute("attrib-cx::int64", int64_t(3));
		...
		}
		{
			...
			attrib = cdoc.FirstChildElement("foo")->FindAttribute("attrib-cx::int64");
			XMLTest("attrib-cx::int64", int64_t(3), attrib->Int64Value(), true);
