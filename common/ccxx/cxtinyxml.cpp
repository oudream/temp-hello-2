...
void CxTinyXml::loadTable2LevelByDocument(const TiXmlDocument &doc, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
...
void CxTinyXml::loadTable2Level(const std::string &sFilePath, std::vector<std::map<string, string> > &rows, const std::string &sDataBaseName,
...
void CxTinyXml::loadTable2Level(const char *pData, int iLength, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName)
{
    if (pData && iLength > 5)
    {
...
void CxTinyXml::loadTable3LevelByDocument(const TiXmlDocument &doc, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                          const string &sTableName, const string &sLevel1Key)
{
    const TiXmlElement *oElementLevel1 = doc.FirstChildElement();
    while (oElementLevel1)
    {
...
void CxTinyXml::loadTable3Level(const string &sFilePath, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName, const string &sLevel1Key)
{
    TiXmlDocument doc;
    if (doc.LoadFile(sFilePath))
...
void CxTinyXml::loadTable3Level(const char *pData, int iLength, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName, const string &sLevel1Key)
{
    if (pData && iLength > 5)
    {
...
void CxTinyXml::loadTable4LevelByDocument(const TiXmlDocument &doc, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                          const string &sTableName, const string &sLevel1Key, const string &sLevel2Key)
{
    const TiXmlElement *oElementLevel1 = doc.FirstChildElement();
    while (oElementLevel1)
    {
...
void CxTinyXml::loadTable4Level(const string &sFilePath, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName, const string &sLevel1Key, const string &sLevel2Key)
{
    TiXmlDocument doc;
    if (doc.LoadFile(sFilePath))
...
void CxTinyXml::loadTable4Level(const char *pData, int iLength, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName, const string &sLevel1Key, const string &sLevel2Key)
{
    if (pData && iLength > 5)
    {
...
void CxTinyXml::loadTable5LevelByDocument(const TiXmlDocument &doc, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                          const string &sTableName, const string &sLevel1Key, const string &sLevel2Key, const string &sLevel3Key)
{
    const TiXmlElement *oElementLevel1 = doc.FirstChildElement();
    while (oElementLevel1)
    {
...
void CxTinyXml::loadTable5Level(const string &sFilePath, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName, const string &sLevel1Key, const string &sLevel2Key, const string &sLevel3Key)
{
    TiXmlDocument doc;
    if (doc.LoadFile(sFilePath))
...
void CxTinyXml::loadTable5Level(const char *pData, int iLength, std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName, const string &sLevel1Key, const string &sLevel2Key, const string &sLevel3Key)
{
    if (pData && iLength > 5)
    {
...
bool CxTinyXml::saveTable4Level(const string &sFilePath, const std::vector<std::map<string, string> > &rows, const string &sDataBaseName,
                                const string &sTableName)
{
...
string CxTinyXml::toXmlBuffer1(const std::vector<string> &sFields, const std::vector<std::vector<string> > &sRows, const string &sLevel1Name,
                               const string &sLevel2Name, const string &sLevel3Name)
{
...
string CxTinyXml::toXmlBuffer2(const std::vector<string> &sFields, const std::vector<std::vector<string> > &sRows, const string &sLevel1Name,
                               const string &sLevel2Name, const string &sLevel3Name)
{
    vector<string> sLines;
    string sLine = CxString::format("<?xml version=\"1.0\" encoding=\"utf-8\" ?><%s><%s>", sLevel1Name.c_str(), sLevel2Name.c_str());
