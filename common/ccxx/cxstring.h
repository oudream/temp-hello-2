...
public:
    ...
    static bool isvalid(const std::string& sSource, cx::uint32) { return isvalidInteger(sSource); }

    static bool isvalid(const std::string& sSource, const cx::int64&) { return isvalidLong(sSource); }

    static bool isvalid(const std::string& sSource, const cx::uint64&) { return isvalidLong(sSource); }
    ...
    //must  : k1=v1,k2=v2,k3=v3
    static std::map<std::string, std::string> splitToMap(const std::string &s, char kvSep, char pairSep, bool trimWS = true, bool keepEmptyPair = false);
