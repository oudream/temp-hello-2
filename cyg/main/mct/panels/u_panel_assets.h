#ifndef UI_U_PANEL_ASSETS_H
#define UI_U_PANEL_ASSETS_H
 ...
 */
class UPanelAssets : public UPanelBase
{
Q_OBJECT
public:
    explicit UPanelAssets(QWidget *parent = 0);

    virtual ~UPanelAssets();
