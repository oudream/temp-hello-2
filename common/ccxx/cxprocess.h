...
public:
    ...
    static bool isvalid(cx::pid_os_t pid);

    static bool isSame(cx::pid_os_t pid1, cx::pid_os_t pid2);
    ...
    static void release(cx::pid_os_t pid);
     ...
     * @return nanosecond
     */
    static cx::nsepoch_t getCpuUsage();
     ...
     * @return nanosecond
     */
    static cx::nsepoch_t getCpuUsage(cx::pid_os_t pid, int *pUsage);
